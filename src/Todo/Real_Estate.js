...
import Results_Real_Estate from './Results_Real_Estate.js'
                    ...
                    <div className='inputs_div'>
                        ...
                        <div className={classes.in_div_two_inputs}>
                            <form className={classes.root} noValidate autoComplete="off">
                                <TextField id="outlined-basic" label="Surface Areaa from" variant="outlined" className={classes.float_left}/>
